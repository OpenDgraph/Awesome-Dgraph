...
**Featherjs/ Django showcases will be added very soon**
...
**Official** Graph DB code repo

#### [badger](https://github.com/dgraph-io/badger) (Go)

Key-value DB used internally in dgraph.

#### [ratel](https://github.com/dgraph-io/ratel) (JavaScript)

Proprietary Dgraph Data and Cluster Manager

### Clients

##### [dgo](https://github.com/dgraph-io/dgo) (Go)

**Official** Dgraph Go client

#### [pydgraph](https://github.com/dgraph-io/pydgraph) (Python)

Python client for Dgraph

#### [dgraph4j](https://github.com/dgraph-io/dgraph4j) (Java)

The official Java client for Dgraph

#### [dgraph-js-http](https://github.com/dgraph-io/dgraph-js-http) (TypeScript)

A Javascript HTTP client for Dgraph

#### [dgraph-js](https://github.com/dgraph-io/dgraph-js) (JavaScript)
...
### [DgraphNet](https://github.com/AlexandreDaSilva/DgraphNet) (C#)

A minimal implementation for a Dgraph client for .NET

### [Dgraph-dotnet](https://github.com/MichaelJCompton/Dgraph-dotnet) (C#)

.Net client for Dgraph

### [dgraph](https://github.com/marceloneppel/dgraph) (Dart)

Dgraph Dart client which communicates with the server using gRPC.

### [dlex](https://github.com/liveforeverx/dlex) (Elixir)

Dlex is a gRPC based client for the Dgraph database.

### [exdgraph](https://github.com/ospaarmann/exdgraph) (Elixir)

gRPC based Elixir Dgraph client. Under development.

## Backend fun

best places to waiste an additionnal 10 minutes

#### [docsearch-configs](https://github.com/dgraph-io/docsearch-configs)

#### [Graphoverflow](https://github.com/dgraph-io/graphoverflow) (JavaScript)

Run the entire StackOverflow on Dgraph. Work in progress.

#### [ldbc_snb_implementations](https://github.com/dgraph-io/ldbc_snb_implementations) (Java)

Vendor implementations for the Interactive Workload component of the LDBC Social Network Benchmark

## Golang hacking

#### [experiments](https://github.com/dgraph-io/experiments) (Go)

#### [badger-bench](https://github.com/dgraph-io/badger-bench) (Go)

Benchmarks of Badger

#### [benchmarks](https://github.com/dgraph-io/benchmarks) (Go)

Run benchmarks with RDF data

#### [wisemonk](https://github.com/dgraph-io/wisemonk) (Go)

Bot to move conversations from Slack to Discourse.

## Weird fun

#### [gru](https://github.com/dgraph-io/gru) (JavaScript)
